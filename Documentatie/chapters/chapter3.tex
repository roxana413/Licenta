\chapter{Problema de selecție a activităților cu profit maxim}
...
\subsection{Reprezentarea datelor de intrare si a celor de ieșire}
\subsection{Tipuri de date folosite în dezvoltarea problemei}

\section{Implementarea propriu-zisă}
\subsection{Detalii de implementare}
\subsection{Metode, funcții, lemme si predicate folosite}
\subsection{Precondiții, postcondițiilor și invarianți}
\subsection{Timeout}

\section{Mod de lucru}
\subsection{Assume false}
